...
import com.fjz.bankline_android.databinding.BankStatementItemBinding
import com.fjz.bankline_android.domain.Movimentacao
import com.fjz.bankline_android.domain.TipoMovimentacao
...
class BankStatementAdapter(private val dataSet: List<Movimentacao>) : RecyclerView.Adapter<BankStatementAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: BankStatementItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item: Movimentacao) = with(binding) {
            ...
            val typeIcon = if(TipoMovimentacao.RECEITA==item.tipo) R.drawable.ic_money_on else R.drawable.ic_money_out
